...
SENSOR_DESCRIPTIONS: Final[tuple[HyundaiKiaBinarySensorEntityDescription, ...]] = (
    ...
    HyundaiKiaBinarySensorEntityDescription(
        ...
        name="EV First Scheduled Departure Climate",
    ...
    HyundaiKiaBinarySensorEntityDescription(
        ...
        name="EV Second Scheduled Departure Climate",
    ...
    HyundaiKiaBinarySensorEntityDescription(
        ...
        name="EV First Scheduled Departure Defrost",
    ...
    HyundaiKiaBinarySensorEntityDescription(
        ...
        name="EV Second Scheduled Departure Defrost",
